...
- **Desenvolvedor**: Daniel Alexandre — [Radio FilispiM](https://github.com/danielalexandreMC)
- **Diseno e concepto**: [Ideia.gal](https://idea.gal) e Radio FilispiM
...
- **Ideia.gal** polo diseno visual e apoio conceptual
- **Radio FilispiM** como emisora piloto e banco de probas
